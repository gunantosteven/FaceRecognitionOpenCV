package com.gunsoft.facerecognitionopencv.method;
...
//		IplImage ipl = MatToIplImage(m,-1, -1);
	...
	//	if ((n[0] != -1)&&(p[0]<95))
	  ...
	  public IplImage MatToIplImage(Mat m,int width,int heigth)
	  {
	...
	public IplImage BitmapToIplImage(Bitmap bmp, int width, int height) {
